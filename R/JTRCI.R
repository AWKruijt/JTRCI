...
warning("a newer version of this package is available at github.com/AWKruijt/JT-RCI (notice the added hyphen). \nThis current version is kept online because I know that there manuscripts using it in their (shared) syntax are currently under review. \nIn time the old JTRCI version will be removed from github and I advise switching to JT-RCI for any new projects. \n\ninstall the new version from github with \n devtools::install_github('awkruijt/JT-RCI')")
